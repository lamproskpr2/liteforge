...
const PACKAGES: PackageCard[] = [
  { name: 'core',      label: 'Signals & Reactivity', href: '/core',      badge: 'foundation', token: 'violet'  },
  { name: 'runtime',   label: 'Components & JSX',     href: '/runtime',   badge: 'foundation', token: 'violet'  },
  { name: 'router',    label: 'Router',               href: '/router',    badge: 'routing',    token: 'blue'    },
  { name: 'query',     label: 'Data Fetching',        href: '/query',     badge: 'data',       token: 'emerald' },
  { name: 'client',    label: 'HTTP Client',          href: '/client',    badge: 'data',       token: 'emerald' },
  { name: 'form',      label: 'Forms',                href: '/form',      badge: 'ui',         token: 'amber'   },
  { name: 'table',     label: 'Tables',               href: '/table',     badge: 'ui',         token: 'amber'   },
  { name: 'modal',     label: 'Modal',                href: '/modal',     badge: 'ui',         token: 'amber'   },
  { name: 'toast',     label: 'Toast',                href: '/toast',     badge: 'ui',         token: 'amber'   },
  { name: 'tooltip',   label: 'Tooltip',              href: '/tooltip',   badge: 'ui',         token: 'amber'   },
  { name: 'calendar',  label: 'Calendar',             href: '/calendar',  badge: 'ui',         token: 'amber'   },
  { name: 'i18n',      label: 'Internationalization', href: '/i18n',      badge: 'plugin',     token: 'blue'    },
  { name: 'admin',     label: 'Admin Panel',          href: '/admin',     badge: 'plugin',     token: 'blue'    },
];
